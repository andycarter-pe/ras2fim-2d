...
def fn_create_raster_products(int_flow_step,
    ...
    str_expected_floodplain_filename = '09_wsel_max_' + str(int_flow_step) + '_floodplain_ar.gpkg'
    ...
    if os.path.exists(str_expected_floodplain_filepath):
        ...
        str_expected_depth_filename = '07_wsel_max_' + str(int_flow_step) + '_depth_with_nan.tif'
        ...
        str_expected_wsel_filename = '08_wsel_max_' + str(int_flow_step) + '_wsel_with_nan.tif'
        ...
        if b_depth_raster_found:
            ...
            str_depth_folder = os.path.join(str_output_folder, 'depth_rasters')
        ...
        if b_wsel_raster_found:
            ...
            str_wsel_folder = os.path.join(str_output_folder, 'wsel_rasters')
            ...
            for index, row in gdf_flowpath_limits_3857.iterrows():
                ...
                list_wsel_rasters.append(str_depth_filepath)
...
def fn_extract_and_simplify_rasters(str_config_file_path,
    ...
    list_flow_columns = [col for col in gdf_flowpath_limits.columns if col.startswith('flow_')]
    ...
    list_of_dict = [{'int_flow_step': i,
                     ...
                     'gdf_flowpath_limits': gdf_flowpath_limits,
...
if __name__ == '__main__':
    ...
    parser.add_argument('-d',
                        ...
                        help=r'REQUIRED: path to folder containing mainstem WSEL and Depth grids (TIF) Example: E:\working\large_dem',
                        required=False,
    ...
    parser.add_argument('-o',
                        dest = "str_output_dir",
                        help=r'REQUIRED: directory to write simplified rasters Example: E:\working\large_dem\mac_dump_rasters',
                        required=False,
                        default=r'E:\working\large_dem\mac_dump_rasters',
                        metavar='DIR',
                        type=str)
