...
def fn_compute_stream_stats(gdf_all_streams,arr_unique_ids,
    ...
    for i in range(len(wsel_columns)):
        ...
        df_stats_this_run = pd.concat([ps_sum_segment_length, ps_sum_segment_length_stable,ps_max_hr_to_stable_on_stream], axis=1)
...
def fn_compute_max_wsel_and_stable_hr(str_config_file_path,
    ...
    try:
        print()
        #print('Step 1')
        shp_travel_path = fn_create_travel_path_shp(gpkg_path, str_start_node, str_end_node)
...
if __name__ == '__main__':
    ...
    parser.add_argument('-i',
                        ...
                        help=r'REQUIRED: path to plan HDF file (HDF) Example: E:\HECRAS_2D_12070205\base_model_20240414_copy\BLE_LBSG_501.p23.hdf',
                        required=False,
                        default=r'E:\HECRAS_2D_12070205\base_model_20240414_copy\BLE_LBSG_501.p23.hdf',
                        metavar='FILE',
                        type=lambda x: is_valid_file(parser, x))
    
    parser.add_argument('-g',
                        dest = "str_model_hydrofabric_path",
                        help=r'REQUIRED: models 2D area hydrofabric (geopackage) Example: E:\sample_2d_output\BLE_LBSG_501_p02\model_hydrofabric.gpkg',
                        required=False,
