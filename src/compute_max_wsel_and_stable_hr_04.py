...
# Created - 2024.06.11
# Revised - 2025.04.05 -- for log progression of flows
...
def fn_parse_run_name(str_run_name):
    #str_run_name = '1884650_wb-2410416_wb-2410422_21-hr_7518-cfs_to_16893-cfs'
    ...
    dict_run_info = {
        ...
        'start_flow': int_start_flow,
        'end_flow': int_end_flow
    }
...
def fn_get_gradient_array_wet_cells(hdf_file_path,int_len_gradient):
    ...
    list_unique_indices_sorted = np.sort(unique_indices).astype(int)

    # TODO - 2025.02.03 - It may be possible that the list_unique_indices_sorted
    # is empty ... what to do here
...
def fn_create_buffered_stream_polygons(str_model_hydrofabric_path,
    ...
    # Added 2025.03.04 -- do this only if str_dwn_stream_id in list_unique_stream_ids
    if str_dwn_stream_id in list_unique_stream_ids:
...
def fn_compute_max_wsel_and_stable_hr(str_config_file_path,
    ...
    int_start_flow = dict_run_info['start_flow']
    int_end_flow = dict_run_info['end_flow']
    # ---
    
    arr_flow_values = fn_logarithmic_progression(flt_min_q, flt_max_q, int_log_q_steps)
    list_flow_steps = fn_generate_log_step_integer(arr_flow_values, int_start_flow, int_end_flow)
    int_number_of_runs = len(list_flow_steps)
...
if __name__ == '__main__':
    ...
    parser.add_argument('-i',
                        ...
                        help=r'REQUIRED: path to plan HDF file (HDF) Example: E:\ras2fim_test_20250107\03_run_hdf\1884650_wb-2410416_wb-2410422_21-hr_7518-cfs_to_16893-cfs.p01.hdf',
                        required=True,
                        metavar='FILE',
                        type=lambda x: is_valid_file(parser, x))
