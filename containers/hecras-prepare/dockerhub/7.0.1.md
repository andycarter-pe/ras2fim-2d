...
The controller checks runtime file fingerprints; the worker checks its wheel,
and the host verifies output fingerprints before staging. These detect changed
files and add I/O. Hashing is a wrapper choice, not a requirement of Wine or
HEC-RAS or a hydraulic check.
...
The tested local candidate identity is `sha256:ed7a120f45151eb538535aa930084b689cf0232081368e42b561f7cfc436b2d0`.
