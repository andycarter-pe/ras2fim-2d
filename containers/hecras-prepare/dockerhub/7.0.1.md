...
**The bundled HEC-RAS 7.0.1 image is installed and tested locally, including saved TCU acceptance. Publication is pending; the bundled image is not yet available to pull.**
...
The command and inventory below describe the tested bundled candidate. Run it
only on a host where that image is already built.
...
[full operating guide](https://github.com/gpt-cmdr/ras2fim-2d/blob/8e9793e674f949c505354023d6a52d6da5c2859e/containers/hecras-prepare/OPERATION.md).
...
Runtime 7.0.1 remains a local candidate pending publication.
...
The selected runtime completed the retained generated-plan sample in 49.15
...
The tested local candidate identity is `sha256:05bd9a0a272381857e0267734fa8ff287659535181ed4ce0c8e259642b65840d`.
This identifies the local build; it is not a pullable image reference.
...
[host-guide]: https://github.com/gpt-cmdr/ras2fim-2d/blob/8e9793e674f949c505354023d6a52d6da5c2859e/containers/hecras-prepare/README.md#run-on-a-windows-drive
[host-tests]: https://github.com/gpt-cmdr/ras2fim-2d/blob/8e9793e674f949c505354023d6a52d6da5c2859e/containers/hecras-prepare/RELEASE-VERIFICATION.md
